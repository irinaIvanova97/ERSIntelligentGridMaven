...
public class Calculator {
    ...
    public List<List<String>> calculateResult() throws IllegalArgumentException{
        Double result1 = 0.0;
        Double result2 = 0.0;
        Double result3 = 0.0;
        ...
        for (int i = 0; i < dataList.size(); i++) {
            ...
            {
                if(formula1.toString().contains(columns.get(4)))
                    throw new IllegalArgumentException(columns.get(4) + " cannot be contained in this formula!");
            ...
            {
                if(formula2.toString().contains(columns.get(5)))
                    throw new IllegalArgumentException(columns.get(5) + " cannot be contained in this formula!");
            ...
            {
                if(formula3.toString().contains(columns.get(6)))
                    throw new IllegalArgumentException(columns.get(6) + " cannot be contained in this formula!");
